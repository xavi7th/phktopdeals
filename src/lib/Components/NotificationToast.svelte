...
<div
  class="notification-toast fixed end-3 top-20 z-50 max-w-xs cursor-pointer rounded-xl shadow-lg transition duration-300 {type === 'success'
    ? 'border-teal-200 bg-teal-100 text-teal-800 dark:border-teal-900 dark:bg-teal-800/20 dark:text-teal-500'
    : ''} {type === 'info' ? 'border-blue-200 bg-blue-100 text-blue-800 dark:border-blue-900 dark:bg-blue-800/20 dark:text-blue-500' : ''} {type === 'error' || type === 'urgent'
    ? 'border-red-200 bg-red-100 text-red-800 dark:border-red-900 dark:bg-red-800/20 dark:text-red-500'
    : ''}"
  role="alert"
  tabindex="0"
