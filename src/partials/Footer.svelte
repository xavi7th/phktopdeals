<footer class="relative z-50 mt-12 w-full overflow-hidden rounded-3xl border-t-[2.5rem] border-brand-400 bg-gray-900 dark:bg-neutral-950">
  ...
  <div class="relative z-10 mx-auto mt-auto w-full max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:pt-12">
    <div class="flex flex-col items-center justify-center text-center">
      <a class="flex-none text-xl font-semibold text-white" href="/" aria-label="Brand">
        <enhanced:img class="mx-auto w-3/5 py-3 text-neutral-400 sm:w-72 lg:py-5" src="$lib/images/logos/logo-wide-light.png?enhance" alt="partner-img-thumb" />
      </a>
      ...
      <div class="mt-3">
        ...
        <p class="text-gray-500 dark:text-neutral-500">© MOZYFLEX LTD Nigeria (RC 1577964). All rights reserved.</p>
      </div>

      <div class="mb-8 mt-3 space-x-2">
        <a
          ...
          href="#">
          <svg class="size-3.5 shrink-0" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            <path
    ...
    <div class="grid grid-cols-2 gap-6 pb-12 md:grid-cols-3 lg:grid-cols-4">
