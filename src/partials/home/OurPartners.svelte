...
<section class="w-full mt-20 mb-10">
  <div class="container">
    <div class="row px-8">
      ...
      <div class="relative overflow-hidden pt-4 bg-neutral-900 dark:bg-gray-800 rounded-xl">
        ...
        <div class="relative z-10">
          <div class="max-w-5xl px-4 xl:px-0 mx-auto">
            ...
            <div class="flex justify-between items-center gap-6">
              ...
              <enhanced:img class="py-3 lg:py-5 w-20 h-auto md:w-28 lg:w-32 text-neutral-400" src="$lib/images/partners/coinbase-logo.png?enhance" alt="partner-img-thumb" />

              <enhanced:img class="py-3 lg:py-5 w-20 h-auto md:w-28 lg:w-32 text-neutral-400" src="$lib/images/partners/gate.io-logo.png?enhance" alt="partner-img-thumb" />

              <enhanced:img class="py-3 lg:py-5 w-32 h-auto md:w-40 lg:w-48 text-neutral-400" src="$lib/images/partners/crypto.com-logo.svg?enhance" alt="partner-img-thumb" />
