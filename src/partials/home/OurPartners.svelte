...
<section class="mb-10 mt-20 w-full">
  <div class="container">
    <div class="row px-8">
      <div class="mx-auto mb-10 max-w-2xl text-center lg:mb-14">
        <h2 class="text-title relative">
          Our Partners

          <SvgIcon svgHeight={25} svgWidth={568} data-static class="absolute -bottom-9 left-1/2 !w-1/4">
      ...
      <div class="relative overflow-hidden rounded-xl bg-neutral-900 pt-4 dark:bg-gray-800">
        ...
        <div class="relative z-10">
          <div class="mx-auto max-w-5xl px-4 xl:px-0">
            ...
            <div class="flex items-center justify-between gap-6">
              <enhanced:img class="h-auto w-20 py-3 text-neutral-400 md:w-28 lg:w-32 lg:py-5" src="$lib/images/partners/binance-logo.png?enhance" alt="partner-img-thumb" />

              <enhanced:img class="h-auto w-20 py-3 text-neutral-400 md:w-28 lg:w-32 lg:py-5" src="$lib/images/partners/coinbase-logo.png?enhance" alt="partner-img-thumb" />

              <enhanced:img class="h-auto w-20 py-3 text-neutral-400 md:w-28 lg:w-32 lg:py-5" src="$lib/images/partners/gate.io-logo.png?enhance" alt="partner-img-thumb" />

              <enhanced:img class="h-auto w-32 py-3 text-neutral-400 md:w-40 lg:w-48 lg:py-5" src="$lib/images/partners/crypto.com-logo.svg?enhance" alt="partner-img-thumb" />

              <svg class="h-auto w-16 py-3 text-neutral-400 md:w-20 lg:w-24 lg:py-5" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2428 1002">
