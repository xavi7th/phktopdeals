...
<aside class="hidden md:block md:w-4/12 lg:w-3/12 pr-4">
        ...
        <ul>
          <li class="item mb-5 flex items-center justify-between">
            <div class="flex items-center space-x-[14px]">
              <div>
                <a class="p-3.5 capitalize tracking-tighter text-gray-600 hover:text-gray-400 focus:text-gray-400 focus:outline-none dark:text-gray-300 dark:hover:text-gray-500 dark:focus:text-gray-500" href="/store/products" aria-current={page.url.pathname == '/store/products' ? "page" : undefined}>
                  All Products
                </a>
              </div>
            </div>
          ...
          {#each main_nav as {name, url}}
            <li class="item mb-5 flex items-center justify-between">
              <div class="flex items-center space-x-[14px]">
                <div>
                  <a class="p-3.5 capitalize tracking-tighter text-gray-600 hover:text-gray-400 focus:text-gray-400 focus:outline-none dark:text-gray-300 dark:hover:text-gray-500 dark:focus:text-gray-500" href="{url}" aria-current={page.url.pathname.includes(url) ? "page" : undefined}>
                    {name}
                  </a>
                </div>
              </div>
