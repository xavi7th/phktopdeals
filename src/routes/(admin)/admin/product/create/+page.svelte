...
<div class="rounded-xl bg-white p-4 shadow sm:p-7 dark:bg-neutral-900">
  <form>
    <div class="grid grid-cols-12 gap-2 border-t border-gray-200 py-8 first:border-transparent first:pt-0 last:pb-0 sm:gap-4 dark:border-neutral-700 dark:first:border-transparent">
      <div class="col-span-12">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Product Management</h2>
      </div>

      <div class="col-span-3">
        <label for="af-submit-application-full-name" class="mt-2.5 inline-block text-sm font-medium text-gray-500 dark:text-neutral-500">Name</label>
      </div>
      ...
      <div class="col-span-3">
        <label for="af-submit-application-resume-cv" class="mt-2.5 inline-block text-sm font-medium text-gray-500 dark:text-neutral-500">Image</label>
      </div>
      ...
      <div class="col-span-3">
        <label for="af-submit-application-email" class="mt-2.5 inline-block text-sm font-medium text-gray-500 dark:text-neutral-500">Product Type</label>
      </div>
      ...
      <div class="col-span-3">
        <label for="af-submit-application-email" class="mt-2.5 inline-block text-sm font-medium text-gray-500 dark:text-neutral-500">Brand</label>
      </div>
      ...
      <div class="col-span-3">
        <label for="af-submit-application-email" class="mt-2.5 inline-block text-sm font-medium text-gray-500 dark:text-neutral-500">Category</label>
      </div>
    ...
    <div class="grid gap-2 border-t border-gray-200 py-8 first:border-transparent first:pt-0 last:pb-0 sm:grid-cols-12 sm:gap-4 dark:border-neutral-700 dark:first:border-transparent">
      <div class="col-span-12">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">Pricing</h2>
      </div>

      <div class="col-span-3">
        <label for="af-submit-application-linkedin-url" class="mt-2.5 inline-block text-sm font-medium text-gray-500 dark:text-neutral-500">Min</label>
      </div>
      ...
      <div class="col-span-3">
        <label for="af-submit-application-twitter-url" class="mt-2.5 inline-block text-sm font-medium text-gray-500 dark:text-neutral-500">Denominations</label>
      </div>
      ...
      <div class="col-span-3">
        <label for="af-submit-application-github-url" class="mt-2.5 inline-block text-sm font-medium text-gray-500 dark:text-neutral-500">Flexible</label>
      </div>
      ...
      <div class="col-span-3">
        <label for="af-submit-application-portfolio-url" class="mt-2.5 inline-block text-sm font-medium text-gray-500 dark:text-neutral-500">Commision</label>
      </div>
      ...
      <div class="col-span-3">
        <label for="af-submit-application-other-website" class="mt-2.5 inline-block text-sm font-medium text-gray-500 dark:text-neutral-500">Discount</label>
      </div>
      ...
      <div class="col-span-3">
        <label for="af-submit-application-other-website" class="mt-2.5 inline-block text-sm font-medium text-gray-500 dark:text-neutral-500">Discount Until</label>
      </div>
    ...
    <div class="grid gap-2 border-t border-gray-200 py-8 first:border-transparent first:pt-0 last:pb-0 sm:grid-cols-12 sm:gap-4 dark:border-neutral-700 dark:first:border-transparent">
      <div class="col-span-12">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-neutral-200">FAQ</h2>
      </div>
