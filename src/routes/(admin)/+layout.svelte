...
<section class="bg-gray-50 dark:bg-neutral-900">
        ...
        <div class="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
          ...
          <div class="hidden md:block">
            ...
            <div class="relative">
              ...
              <input type="text" class="py-2 ps-10 pe-16 block w-full bg-white border-gray-200 rounded-lg text-sm focus:outline-none focus:border-brand-500 focus:ring-brand-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder:text-neutral-400 dark:focus:ring-neutral-600" placeholder="Search">
              <div class="hidden absolute inset-y-0 end-0 flex items-center pointer-events-none z-20 pe-1">
                <button type="button" class="inline-flex shrink-0 justify-center items-center size-6 rounded-full text-gray-500 hover:text-brand-600 focus:outline-none focus:text-brand-600 dark:text-neutral-500 dark:hover:text-brand-500 dark:focus:text-brand-500" aria-label="Close">
          ...
          <div class="flex flex-row items-center gap-1">
            ...
            <div class="items-center rounded-full p-0.5 px-0 sm:order-3 flex">
              <button
                type="button"
    ...
    <!-- Content -->
    <div class="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 mt-5">
        <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
        <ul class="flex flex-col space-y-1">
          {#each admin_route as nav}
            <li>
              <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg focus:outline-none dark:text-white" href={nav.uri} class:bg-gray-100={$page.url.pathname == nav.uri} class:bg-neutral-700={$page.url.pathname == nav.uri}  class:text-white={$page.url.pathname == nav.uri}>
                  {@html nav.icon}
                  {nav.name}
              </a>
            </li>
