...
<div class="container py-10 sm:py-40">
    <div class="flex justify-center">
        <div class="register-card my-10 sm:w-auto w-full sm:bg-white rounded-xl">
            <div class="sm:w-[500px] w-full p-12">
                <div class="mb-8 text-center text-5xl font-extrabold tracking-tight"> Sign Up</div>
                    <form action="" class="flex flex-col gap-4">
                        <div class="flex gap-1 mb-4">
                            <span>I have an account?</span> <a href="#" class="text-[#FFDA1C]">Sign In</a>
                        </div>
                        ...
                        <div class="flex flex-col justify-center gap-4 text-sm">
                            <p>By Registering, I Accept The <a href="#" class="text-[#FFDA1C]">Terms</a> and <a href="#" class="text-[#FFDA1C]">Privacy Policy</a> Of This Site.</p>
                            <PrimaryBtn data={{
                                innerText: 'Sign Up',
                            }} />
                        </div>
                    ...
                    <div class="flex flex-col gap-2">
                        <button type="button" class="relative h-[38px] border">
                            <span class="text-sm rounded-sm">Sign Up with Google</span>
                        ...
                        <button type="button" class="relative h-[38px] border">
                            <span class="text-sm rounded-sm">Sign Up with Binance</span>
                        ...
                        <button type="button" class="relative h-[38px] border">
                            <span class="text-sm rounded-sm">Sign Up with Facebook</span>
