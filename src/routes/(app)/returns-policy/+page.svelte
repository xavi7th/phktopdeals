...
<svelte:head>
  ...
  <meta name="description" content="Learn about PHK Factor's returns and refund policy for digital products including games, gift cards, e-SIM, top-ups, and vouchers." />
</svelte:head>
...
<div class="mx-auto max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8">
  <article
    class="prose mx-auto max-w-3xl dark:prose-invert prose-headings:font-bold prose-h2:mt-10 prose-h2:border-b prose-h2:border-gray-200 prose-h2:pb-3 prose-h2:text-xl prose-h2:sm:text-2xl dark:prose-h2:border-neutral-700">
    ...
    <p>
      At PHK Factor, we are committed to ensuring your satisfaction with every purchase. Because the majority of our products are digital in nature, our returns and refund policy is designed to be fair to both our
      customers and our service partners.
    </p>
    <p>Please read this policy carefully before making a purchase. By completing a transaction on our platform, you acknowledge that you have read and understood this policy.</p>
    ...
    <ul>
      <li>
        The refund amount is credited to your <strong>PHK Factor wallet</strong>
        .
      </li>
      <li>Wallet credit can be used immediately for any purchase on the platform.</li>
      <li>
        Wallet credit has <strong>no expiration date</strong>
        .
      </li>
      <li>
    ...
    <ul>
      <li>
        Wallet credit is typically applied within <strong>24-48 hours</strong>
        .
      </li>
