...
<div class="mb-28 rounded-xl bg-white p-10 px-4 shadow-lg sm:mx-10 dark:bg-[#404040]">
  ...
  <div data-tour="verify-step-indicator" class="mt-10 flex items-center justify-between gap-4 text-slate-800 md:px-6 dark:text-slate-200">
    ...
    <hr class="flex-1" />
    <div class="flex items-center gap-2">
      <p class="grid size-6 place-content-center rounded-full bg-[#64748b] text-sm">2</p>
      <span class="text-[.6em] md:text-sm">Proof of address</span>
    </div>
    <hr class="flex-1" />
    <div class="flex items-center gap-2">
      <p class="grid size-6 place-content-center rounded-full bg-[#64748b] text-sm">3</p>
      <span class="text-[.6em] md:text-sm">Done</span>
    </div>
  </div>
  <div class="mt-8 pb-12 text-slate-800 sm:px-10 dark:text-slate-200">
