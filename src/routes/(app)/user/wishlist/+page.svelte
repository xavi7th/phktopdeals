      ...
      <div class="relative p-4 md:p-5">
        ...
        <div class="sm:text-auto mt-1 items-center gap-2 text-[12px] text-gray-500 sm:flex dark:text-neutral-600">
          <div class="flex items-center gap-1">
            <svg viewBox="0 0 24 24" class="size-[1.2em]" fill="currentColor" preserveAspectRatio="xMidYMid meet" focusable="false">
        ...
        <div class="absolute right-6 top-[50%] flex translate-y-[-50%] gap-6 px-2">
          <button>
