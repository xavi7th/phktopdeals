...
<div>
  <a
    href="https://wa.me/+2348166272605?text=Hello Hotdeals team, I need assistance"
    class="fixed bottom-5 right-5 z-[999] block rounded-full shadow-sm transition-transform duration-150 hover:scale-110 md:bottom-10 md:right-10 dark:shadow-neutral-600"
    aria-label="whatsapp"
    target="_blank">
    <svg xmlns="http://www.w3.org/2000/svg" class="size-14 md:size-16" viewBox="0 0 256 258">
      <defs>
