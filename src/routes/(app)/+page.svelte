...
<div>
  <a href="https://wa.me/+2348166272605?text=Hello Hotdeals team, I need assistance" class="block fixed md:bottom-10 bottom-5 md:right-10 right-5 shadow-sm dark:shadow-neutral-600 rounded-full hover:scale-110 transition-transform duration-150 z-[999]" aria-label="whatsapp" target="_blank">
